...
flags.DEFINE_string("dataset", "LFW_128", "The name of dataset [celebA, mnist, lsun]")
flags.DEFINE_string("sampleset", "LFW_128", "The name of sample set [celebA, mnist, lsun]")
