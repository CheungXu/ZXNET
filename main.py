...
flags.DEFINE_string("dataset", "celeba_128", "The name of dataset [celebA, mnist, lsun]")
flags.DEFINE_string("sampleset", "celeba_128", "The name of sample set [celebA, mnist, lsun]")
flags.DEFINE_string("mask_type", "LEFT", "The type of image mask [LEFT, RIGHT, BOTTOM]")
...
def main(_):
  ...
  with tf.Session(config=run_config) as sess:
    dcgan = DCGAN(
          ...
          sampleset_name=FLAGS.sampleset,
